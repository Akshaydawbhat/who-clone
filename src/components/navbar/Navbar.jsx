...
import HealthTopic from "./../HealthTopic/HealthTopic";
      ...
      <article>
        <main>
          ...
          <div className={style.nav1}>
            ...
            <div className={style.nav1_right}>
          ...
          > 
            <g id="Layer_2" data-name="Layer 2">
              ...
              <g id="ENGLISH">
                ...
                <path
                  class="cls-1"
                  d="M393.06,95.16h8.81V104h-8.81Zm.13,15.83h8.54v37.23h-8.54Z"
                ></path>
                <path
                  class="cls-1"
                ...
                <path
                  class="cls-1"
                  d="M498,95.16h8.81V104H498ZM499.1,111h8.54v37.23H499.1Z"
                ></path>
                <path
                  class="cls-1"
          ...
          <div className={style.nav3}>
            ...
            <div className={style.nav3_subDiv}>
              <Link to={"/HomePage"} className={style.nav3_menu}>
              <i class="fa-solid fa-house-chimney fa-lg"></i>
              </Link>

              <Link to={"/HealthTopic"} className={style.nav3_menu}>
                Health Topic
                <i class="fa-solid fa-angle-down"></i>
              </Link>
